    ...
    <div className="edit">
      ...
      <form className="edit__form">
        <div className="edit__form-warehouse">
          ...
          <label className="edit__form-warehouse-label" htmlFor="edit__form-warehouse-name">Warehouse Name</label>
          <input
            className="edit__form-warehouse-name"
            id="edit__form-warehouse-name"
            type="text"
            placeholder="Warehouse Name"
            name="name"
          />
          <label className="edit__form-warehouse-label" htmlFor="edit__form-warehouse-street">Street Address</label>
          <input
            className="edit__form-warehouse-street"
            id="edit__form-warehouse-street"
            type="text"
            placeholder="Street Address"
            name="street"
          />
          <label className="edit__form-warehouse-label" htmlFor="edit__form-warehouse-city">City</label>
          <input
            className="edit__form-warehouse-city"
            id="edit__form-warehouse-city"
            type="text"
            placeholder="City"
            name="city"
          />
          <label className="edit__form-warehouse-label" htmlFor="edit__form-warehouse-country">Country</label>
          <input
            className="edit__form-warehouse-country"
        ...
        <h2 className="edit__form-contact-title">Contact Details</h2>
          ...
          <input
            className="edit__form-contact-name"
